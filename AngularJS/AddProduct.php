...
<div class="app app-default" ng-app="Product" ng-controller="ProductC" ng-init="get_category()">
							...
							<div class="row">
  							...
  							<div class="form-group">
      							<div class="col-md-9 col-md-offset-3">
       								 <button ng-click="add_product()" type="submit" class="btn btn-primary" >Save</button>
